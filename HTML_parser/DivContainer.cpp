...
void DivContainer::newDiv(const char* divDescr)
{
	...
	descriptions= divDescr;
	tags[size++] = new TagConteiner();
}
...
void DivContainer::resize()
{
	...
	{
		descriptions = "";
		tags = new TagConteiner * [maxSize + 5];
		maxSize += 5;
	}
	else
	{
		std::string tempChar = "";
		TagConteiner** tempTag = new TagConteiner * [maxSize * 2];
